...
# redux-toolkit-tutorial-freecodecamp-youtube-tutorial
<a name="readme-top"></a>
...
<div align="center">
  ...
  <h3><b>redux-toolkit-tutorial-freecodecamp-youtube-tutorial</b></h3>
...
# ⭐ redux-toolkit-tutorial-freecodecamp-youtube-tutorial <a name="about-project"></a>

**This is the final code after following along with this freecodecamp [tutorial](https://www.youtube.com/watch?v=bbkBuqC1rU4).** 
...
```sh
  cd my-folder
  git clone git@github.com:Braingenius2/redux-toolkit-tutorial-microverse-exercise.git
```
...
Feel free to check the [issues page](https://github.com/Braingenius2/Math-Magicians/issues).
